...
<path d="M3 7.6L5.54545 10L10 4" stroke="#222222"/>
          ...
          <button className="text-end pl-4" onClick={() => handleDeleteCompletedTask(index)}><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
